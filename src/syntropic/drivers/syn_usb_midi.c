/**
 * @file syn_usb_midi.c
 * @brief Zero-Heap USB 2.0 MIDI Class Device Driver Implementation.
 * @ingroup syn_drivers
 */
...
/**
 * @brief Setup handler callback for USB MIDI class setup requests.
 * @param ctx Class driver context (SYN_USB_MIDI pointer).
...
/**
 * @brief Data OUT handler callback for USB MIDI OUT endpoint data.
 * @param ctx Class driver context (SYN_USB_MIDI pointer).
...
/**
 * @brief Data IN handler callback for USB MIDI IN endpoint completion.
 * @param ctx Class driver context (SYN_USB_MIDI pointer).
 * @param ep Endpoint address.
 */
...
/**
 * @brief Configured callback for USB MIDI class interface activation.
 * @param ctx Class driver context (SYN_USB_MIDI pointer).
...
/**
 * @brief Queue a 4-byte USB MIDI Event Packet into TX buffer.
 * @param midi Pointer to USB MIDI instance.
 * @param cin Code Index Number (4 bits).
 * @param status MIDI status byte.
 * @param param1 MIDI parameter 1 byte.
 * @param param2 MIDI parameter 2 byte.
