/**
 * @file syn_xrce_dds.c
 * @brief Micro-ROS & eProsima Micro XRCE-DDS v1.2 Protocol Client Engine Implementation.
 */
...
/** @brief Default client heartbeat period in milliseconds */
#define SYN_XRCE_DEFAULT_HEARTBEAT_MS 5000U
/** @brief XRCE submessage little-endian endianness flag */
#define SYN_XRCE_FLAG_LITTLE_ENDIAN 0x01U
/** @brief XRCE object representation by reference */
#define SYN_XRCE_REPRESENTATION_BY_REF 0x01U
/** @brief XRCE object representation as string / XML */
#define SYN_XRCE_REPRESENTATION_AS_STRING 0x02U
/** @brief XRCE data submessage format: Raw Data payload */
#define SYN_XRCE_DATA_FORMAT_DATA 0x00U

/* ── Internal Helper: CDR Alignment ──────────────────────────────────────── */

/**
 * @brief Align CDR writer position to specified byte boundary with zero padding.
 * @param w Writer context.
 * @param align Alignment boundary in bytes (2, 4, 8).
...
/**
 * @brief Align CDR reader position to specified byte boundary.
...
/**
 * @brief Write XRCE message header to CDR stream.
 * @param w Writer context.
 * @param session_id XRCE session identifier.
 * @param stream_id XRCE stream identifier.
 * @param seq_num Stream sequence number.
 * @param client_key 32-bit client key.
 */
...
/**
 * @brief Start XRCE submessage with 4-byte header and return length patch offset.
 * @param w Writer context.
 * @param submsg_id Submessage identifier.
 * @param flags Submessage flags.
 * @return Byte offset of submessage length field for later patching.
 */
...
/**
 * @brief Finish XRCE submessage and patch calculated payload length.
 * @param w Writer context.
 * @param len_pos Byte offset of submessage length field.
 */
...
/**
 * @brief Register local XRCE object in client's internal entity table.
 * @param client Client instance pointer.
 * @param id Object identifier.
 * @param kind Object kind (participant, topic, publisher, etc.).
 * @param parent Parent object identifier.
 * @return SYN_OK on success, SYN_ERROR on table overflow.
 */
