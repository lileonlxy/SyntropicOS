/**
 * @file syn_ble_hci.c
 * @brief Zero-Heap Host Controller Interface (HCI) Driver implementation.
 */
...
#define SYN_BLE_HCI_RX_STATE_TYPE 0U    /**< RX State: Packet Type */
#define SYN_BLE_HCI_RX_STATE_HDR 1U     /**< RX State: Header */
#define SYN_BLE_HCI_RX_STATE_PAYLOAD 2U /**< RX State: Payload */
...
/**
 * @brief Internal parse and dispatch helper.
 * @param hci HCI driver handle.
 */
