/**
 * @file syn_ble_gatt.c
 * @brief Zero-Heap Generic Attribute Profile (GATT) Implementation.
 */
...
/**
 * @brief Internal attribute lookup helper.
 * @param gatt GATT server handle.
 * @param handle Attribute handle.
 * @return Attribute pointer or NULL.
 */
