/**
 * @file syn_ntp_server.c
 * @brief Zero-Heap NTP v4 Server Implementation.
 * @ingroup syn_net
 */
...
/**
 * @brief Write 32-bit integer into big-endian byte buffer.
 * @param buf Pointer to 4-byte destination buffer.
